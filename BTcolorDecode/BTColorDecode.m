...
%INPUT%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
basename='032819_1'; legend_str={'EHEC','MG1655','KB242'}; thresholds=[1500 1250];  t1=[15 27 39 51 63];  t2=[17 29 41 53 66];%Plasmolysis lysis of MG1655, KB242, EHEC pooled, occlusion microscopy
...
movie_directory=['/Users/Rico/Documents/MATLAB/Matlab Ready/' basename '/' basename '_1_a' ];%Directory in which movie is saved
color_directory=['/Users/Rico/Documents/MATLAB/Matlab Ready/' basename '/' basename '_col' ];%Directory in which color 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
load([basename '_BT'],'T','pixels','v','lcell','tmid','ncells','B')

    cd(color_directory); 
    imagename=fluo_directory(1).name;
    TestIm=imread(imagename);
    cd(movie_directory); 
    imagename=phase_directory(end).name;
...
for i=2:ncolors
    ...
    positive_cells{i}=find(intensities_temp>thresholds(i-1));    
